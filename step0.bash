...
git clone https://github.com/ryuichiueda/ros_setup_scripts_Ubuntu17.04_server.git

# If your git gives a SSL error, please try this.  ###
#GIT_SSL_NO_VERIFY=1 git clone https://github.com/ryuichiueda/ros_setup_scripts_Ubuntu17.04_server.git
